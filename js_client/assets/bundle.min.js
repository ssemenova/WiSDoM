...
var learningType = require("./learning-type.vue");
...
__vue__options__.render = function(){with(this){return _h('div',{staticClass:"container",attrs:{"id":"wisdom"}},[_h('div',{staticClass:"row"},[_h('div',{staticClass:"col-md-6"},[_h('learning-type')])," ",_h('div',{staticClass:"col-md-6"},[_h('query-templates')])])," ",_h('div',{staticClass:"row"},[_h('div',{staticClass:"col-md-6"},[_h('sla-selection')])," ",_h('div',{staticClass:"col-md-6"},[_h('sla-recs')])])," ",_h('div',{staticClass:"row"},[_h('div',{staticClass:"col-md-12"},[_h('strategy')])])])}}
...
},{"./learning-type.vue":3,"vue":6,"vue-hot-reload-api":5}],2:[function(require,module,exports){
...
__vue__options__.staticRenderFns = [function(){with(this){return _h('div',{staticClass:"panel panel-default",attrs:{"id":"learning_type"}},[_h('div',{staticClass:"panel-heading"},[_h('h3',{staticClass:"panel-title"},["Learning type"])])," ",_h('div',{staticClass:"panel-body"},[_h('form',[_h('div',{staticClass:"radio"},[_h('label',[_h('input',{attrs:{"type":"radio","name":"type-radio","value":"slearn","checked":""}})," ",_h('strong',["Supervised learning"]),": WiSeDB can generate ",_h('em',["decision tree models"])," tailored to a specific application's workload. This supports ",_h('em',["SLA recommendation"])," and ",_h('em',["batch scheduling"]),".\n        "])])," ",_h('div',{staticClass:"radio"},[_h('label',{staticClass:"radio"},[_h('input',{attrs:{"type":"radio","name":"type-radio","value":"rlearn"}})," ",_h('strong',["Reinforcment learning"]),": WiSeDB can use a tiered network of ",_h('em',["contextual multi-armed bandits"])," for ",_h('em',["online processing"])," of queries that ",_h('em',["responds to changes on the fly"]),".\n        "])])])])])}}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
