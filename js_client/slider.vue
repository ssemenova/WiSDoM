...
module.exports = {
    ...
    mounted: function () {
        ...
        // grab the "this" instace for this component,
        // because when the callback gets called this will be
        // bound to something else. Classic JS nonsense :)
        const vm = this;
        this.$el.noUiSlider.on('update', function (values, handle) {
            vm.value = values[handle];
            vm.$emit("value-changed", vm.value);
        });
    },
